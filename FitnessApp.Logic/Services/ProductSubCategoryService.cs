...
namespace FitnessApp.Logic.Services 
{
    public class ProductSubCategoryService : BaseService, IProductSubCategoryService
    {
        ...
        public async Task CreateAsync(ProductSubCategoryDto productSubCategoryDto)
        {
            ...
            {
                _eventBus.Publish(new LogEvent(Statuses.Fail, Actions.Creation, EntityTypes.ProductSubCategory,
        ...
        public async Task UpdateAsync(ProductSubCategoryDto productSubCategoryDto) 
        {
            ...
            if (subCategoryDb != null)
            {
                ...
                {
                    _eventBus.Publish(new LogEvent(Statuses.Fail, Actions.Update, EntityTypes.ProductSubCategory,
                        $"Changes was not saved in data base: {ex.Message}"));
        ...
        public async Task DeleteAsync(int? productSubCategoryId)
        {
            ...
            if (subCategoryDb != null)
            {
                ...
                {
                    _eventBus.Publish(new LogEvent(Statuses.Fail, Actions.Deletion, EntityTypes.ProductSubCategory,
                        $"Changes was not saved in data base: {ex.Message}"));
