...
namespace FitnessApp.Logic.Services
{
    public class ProductService : BaseService, IProductService
    {
        ...
        public async Task CreateAsync(ProductDto productDto)
        {
            ...
            {
                _eventBus.Publish(new LogEvent(Statuses.Fail, "Creation", ProductDto.ENTITY_TYPE,
        ...
        public async Task UpdateAsync(ProductDto productDto)
        {
            ...
            if (productDb != null)
            {
                ...
                {
                    _eventBus.Publish(new LogEvent(Statuses.Fail, "Update", ProductDto.ENTITY_TYPE, 
                        $"Changes was not saved in data base: {ex.Message}"));
        ...
        public async Task DeleteAsync(int? productId)
        {
            ...
            if (productDb != null)
            {
                ...
                {
                    _eventBus.Publish(new LogEvent(Statuses.Fail, "Deletion", ProductDto.ENTITY_TYPE, 
                        $"Changes was not saved in data base: {ex.Message}"));
