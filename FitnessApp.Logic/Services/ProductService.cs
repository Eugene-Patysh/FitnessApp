...
namespace FitnessApp.Logic.Services
{
    public class ProductService : BaseService, IProductService
    {
        ...
        public async Task CreateAsync(ProductDto productDto)
        {
            ...
            {
                _eventBus.Publish(new LogEvent(Statuses.Fail, "Creation", productDto.GetType().Name.Replace("Dto", ""), "Changes was not saved in data base"));
        ...
        public async Task UpdateAsync(ProductDto productDto)
        {
            ...
            if (productDb != null)
            {
                ...
                {
                    _eventBus.Publish(new LogEvent(Statuses.Fail, "Update", productDto.GetType().Name.Replace("Dto", ""), "Changes was not saved in data base"));
