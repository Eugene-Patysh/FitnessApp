...
namespace FitnessApp.Logic.Services
{
    public class NutrientCategoryService : BaseService, INutrientCategoryService
    {
        ...
        public NutrientCategoryService(ProductContext context, ICustomValidator<NutrientCategoryDto> validator, 
        ...
        public async Task CreateAsync(NutrientCategoryDto nutrientCategoryDto)
        {
            ...
            {
                _eventBus.Publish(new LogEvent(Statuses.Fail, Actions.Creation, EntityTypes.NutrientCategory,
        ...
        public async Task UpdateAsync(NutrientCategoryDto nutrientCategoryDto)
        {
            ...
            if (nutrientCategoryDb != null)
            {
                ...
                {
                    _eventBus.Publish(new LogEvent(Statuses.Fail, Actions.Update, EntityTypes.NutrientCategory,
                        $"Changes was not saved in data base: {ex.Message}"));
        ...
        public async Task DeleteAsync(int? nutrientCategoryId)
        {
            ...
            if (nutrientCategoryDb != null)
            {
                ...
                {
                    _eventBus.Publish(new LogEvent(Statuses.Fail, Actions.Deletion, EntityTypes.NutrientCategory, 
                        $"Changes was not saved in data base: {ex.Message}"));
